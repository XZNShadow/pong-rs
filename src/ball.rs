...
// Ball speeds
const BALL_XSPEED: f32 = 250.0;
const BALL_YSPEED: f32 = 250.0;
// Ball starting position
const BALL_START_POS: Vec3 = Vec3 {
    x: 0.0,
    y: 0.0,
    z: 0.0,
};
...
fn spawn(
    ...
    commands.spawn((
        MaterialMesh2dBundle {
            ...
            transform: Transform::from_translation(BALL_START_POS)
                .with_scale(Vec2::splat(BALL_RADIUS).extend(1.0)),
            ..default()
        },
        Ball {
            speed_x: BALL_XSPEED,
